...
FROM --platform=$BUILDPLATFORM quay.io/twz123/golang:1.20.8-alpine-edge as bins
ARG VERSION HASH
...
FROM docker.io/library/alpine:20230901 as busybox
RUN apk add busybox-static


FROM docker.io/library/alpine:20230901 as baselayout
